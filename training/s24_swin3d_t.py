"""S24-swin3d: torchvision swin3d_t on PIXEL_CACHE_V1 9-slice volumes.

Same labels/folds/seed/recipe as S24 r3d_18. Only the 3D backbone changes.
Swin3D-T native 3-channel T=9 works; MViT-v2 does not accept T=9.
"""
...
def build_model(n_targets: int = 12, pretrained: bool = True, dropout: float = 0.2, fusion_hidden: int = 0):
    ...
    class PlaneHead(nn.Module):
        def __init__(self):
            ...
            trunk = swin3d_t(weights=weights)
    ...
    return S24Swin3DT(n_targets=n_targets, dropout=dropout, fusion_hidden=fusion_hidden)
...
def main() -> None:
    ...
    parser.add_argument("--experiment-key", type=str, default="S24_SWIN3D_T_9SLICE")
    ...
    if args.train:
        ...
        return
    print(json.dumps({"smoke": True, "layout": "vol9", "arch": "swin3d_t"}))
