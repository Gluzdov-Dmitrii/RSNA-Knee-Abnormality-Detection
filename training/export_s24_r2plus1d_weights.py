"""Strip S24 r2plus1d_18 fold checkpoints to fp16 state_dicts.
...
DEFAULT_SRC = PROJECT / "runs/20260910T0745Z-s24-r2plus1d-9slice/checkpoints"
DEFAULT_OUT = PROJECT / "export/s24-r2plus1d-9slice-folds"
CODE_CANDIDATES = [
...
def main() -> None:
    ...
    for code in CODE_CANDIDATES:
        if (code / "s24_r2plus1d_18.py").is_file() and str(code) not in sys.path:
            sys.path.insert(0, str(code))
            break
    from s24_r2plus1d_18 import build_model
    ...
    manifest = {
        "schema_version": "s24_r2plus1d_9slice_folds_fp16_v1",
        "experiment_id": "S24",
