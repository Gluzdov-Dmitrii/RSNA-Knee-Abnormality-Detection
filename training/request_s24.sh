...
if [[ ! -f "$RUN/queue.id" ]]; then
  echo "rsna-s24-20260910T0545Z" > "$RUN/queue.id"
fi
...
run = Path("/home/scientists/gluz_d_s/kaggle/projects/rsna-knee-abnormality-detection/runs/20260910T0545Z-s24-r3d18-9slice")
