"""S24-r2plus1d: torchvision r2plus1d_18 on PIXEL_CACHE_V1 9-slice volumes.
...
def build_model(n_targets: int = 12, pretrained: bool = True, dropout: float = 0.2, fusion_hidden: int = 0):
    ...
    class PlaneHead(nn.Module):
        def __init__(self):
            ...
            trunk = r2plus1d_18(weights=weights)
    ...
    return S24R2Plus1D18(n_targets=n_targets, dropout=dropout, fusion_hidden=fusion_hidden)
...
def main() -> None:
    ...
    parser.add_argument("--experiment-key", type=str, default="S24_R2PLUS1D_9SLICE")
    ...
    if args.train:
        ...
        return
    print(json.dumps({"smoke": True, "layout": "vol9", "arch": "r2plus1d_18"}))
