...
if [[ ! -f "$RUN/queue.id" ]]; then
  echo "rsna-s24-r2p-20260910T0745Z" > "$RUN/queue.id"
fi
...
run = Path("/home/scientists/gluz_d_s/kaggle/projects/rsna-knee-abnormality-detection/runs/20260910T0745Z-s24-r2plus1d-9slice")
