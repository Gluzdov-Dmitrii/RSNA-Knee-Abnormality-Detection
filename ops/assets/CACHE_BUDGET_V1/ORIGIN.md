...
Denser methods notebook: `dmitriigluzdov/rsna-knee-on-a-storage-budget` **v2 COMPLETE** (15 points, 200 studies). Receipt: `RECEIPT_V2.json`. Curves: `cache_budget_v2_curve.png`, `cache_budget_v2_ssim.png`.
