"""Day-4 open-code pipeline: infer all five, then submit once each."""
...
STATE_PATH = ROOT / "tmp" / "day4_state.json"
LOG_PATH = ROOT / "tmp" / "day4_orchestrator.log"
...
JOBS = [
    {
        "name": "dino_v5",
        "folder": str(ROOT / "tmp" / "ready_d4" / "d4-dino-v5"),
        "kernel": "dmitriigluzdov/rsna-knee-open-rsna-base-0936",
        "message": "open fork hyakumanben2025/rsna-knee-dinosaur-v5-repro public 0.936",
        "backup_folder": str(ROOT / "tmp" / "ready_d4" / "d4-raptor-w080"),
        "backup_message": "open fork hdhsjdjd/rsna-knee-raptor-quad-w080 public 0.935",
    },
    {
        "name": "nishant_v16",
        "folder": str(ROOT / "tmp" / "ready_d4" / "d4-nishant-v16"),
        "kernel": "dmitriigluzdov/rsna-knee-take-care-of-your-knee",
        "message": "open fork nishantkharga/rsna-knee-4-arm-v16-slothead-nk public 0.935",
    },
    {
        "name": "fanch",
        "folder": str(ROOT / "tmp" / "ready_d4" / "d4-fanch"),
        "kernel": "dmitriigluzdov/rsna-open-sol-v6",
        "message": "open fork fanch123/rsna-knee-e0-v16-crossfit-gated public 0.935",
        "backup_folder": str(ROOT / "tmp" / "ready_d4" / "d4-pranjal"),
        "backup_message": "open fork pranjalverma08/rsna-knee-climbing-up-the-hill-the-ensemble-way public 0.935",
    },
    {
        "name": "anthony",
        "folder": str(ROOT / "tmp" / "ready_d4" / "d4-anthony"),
        "kernel": "dmitriigluzdov/rsna-open-sol-fusion",
        "message": "open fork anthonytherrien/rsna-knee-dino-radimagenet-dual-coatnet public 0.935",
        "backup_folder": str(ROOT / "tmp" / "ready_d4" / "d4-pranjal-fusion"),
        "backup_message": "open fork pranjalverma08/rsna-knee-climbing-up-the-hill-the-ensemble-way public 0.935",
    },
    {
        "name": "sankurero",
        "folder": str(ROOT / "tmp" / "ready_d4" / "d4-sankurero"),
        "kernel": "dmitriigluzdov/rsna-open-sol-raptor",
        "message": "open fork sankurero/rsna-knee-coatnet-raptor-only public 0.935",
    },
]
