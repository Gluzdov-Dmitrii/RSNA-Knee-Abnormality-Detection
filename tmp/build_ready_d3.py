...
OPEN = ROOT / "tmp" / "open_kernels_d3"
OUT = ROOT / "tmp" / "ready_d3"
...
JOBS = [
    {
        "origin": "prvsiyan__head-and-shoulders-knees-and-toes",
        "kernel": "dmitriigluzdov/rsna-knee-open-rsna-base-0936",
        "title": "RSNA Knee Open rsna-base 0936",
        "folder": "d3-prvsiyan",
        "id_no": 132790146,
        "origin_ref": "prvsiyan/head-and-shoulders-knees-and-toes",
        "score": "0.936",
    },
    {
        "origin": "lynnsakurai__rsna-knee-dinosaur-v4-5-validated-repro",
        "kernel": "dmitriigluzdov/rsna-knee-take-care-of-your-knee",
        "title": "RSNA Knee: Take Care Of Your Knee",
        "folder": "d3-lynn",
        "origin_ref": "lynnsakurai/rsna-knee-dinosaur-v4-5-validated-repro",
        "score": "0.936",
    },
    {
        "origin": "maverickss26__rsna-knee-restructured-version-2",
        "kernel": "dmitriigluzdov/rsna-open-sol-v6",
        "title": "rsna-open-sol-v6",
        "folder": "d3-maverick",
        "origin_ref": "maverickss26/rsna-knee-restructured-version-2",
        "score": "0.936",
    },
    {
        "origin": "junaid512__rsna-base-enc",
        "kernel": "dmitriigluzdov/rsna-open-sol-fusion",
        "title": "rsna-open-sol-fusion",
        "folder": "d3-junaid",
        "origin_ref": "junaid512/rsna-base-enc",
        "score": "0.936",
    },
    {
        "origin": "nishantkharga__rsna-knee-full-4-arm-ensemble-v55",
        "kernel": "dmitriigluzdov/rsna-open-sol-raptor",
        "title": "rsna-open-sol-raptor",
        "folder": "d3-nishant-v55",
        "origin_ref": "nishantkharga/rsna-knee-full-4-arm-ensemble-v55",
        "score": "0.935",
    },
    {
    ...
    for job in JOBS:
        ...
        for cell in nb["cells"]:
            ...
            for old in OLD_ASSETS:
                if old in new_src:
                    new_src = new_src.replace(old, RESOLVER, 1)
                    replaced += 1
            if new_src != src:
                cell["source"] = new_src
