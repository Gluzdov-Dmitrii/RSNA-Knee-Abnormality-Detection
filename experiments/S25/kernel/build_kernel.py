"""Build a one-cell GPU notebook: live PIXEL_CACHE_V1 decode + r3d/r2p rank-mean."""
...
CELL = Path(__file__).resolve().parent / "s25_rankmean_cell.py"
DOCKER = "gcr.io/kaggle-private-byod/python@sha256:37c64f7dd9c54116ecd1bcc88817c5469b88387388fade02bfa8bf3fc647d461"
KERNEL = "dmitriigluzdov/rsna-s25-r3d-r2p-rankmean"
TITLE = "rsna-s25-r3d-r2p-rankmean"
CODE_FILE = "rsna-s25-r3d-r2p-rankmean.ipynb"
DATASETS = [
    "dmitriigluzdov/rsna-s24-r3d18-9slice-folds",
    "dmitriigluzdov/rsna-s24-r2plus1d-9slice-folds",
]
OUT_DIR = ROOT / "tmp" / "kernel_s25_rankmean"
PUSH_DIR = ROOT / "tmp" / "kernel_s25_rankmean_push"
...
def main() -> None:
    ...
    if not source.startswith("# S25_RANKMEAN_R3D_R2P"):
        raise SystemExit("rank-mean cell marker missing")
    nb = {
        "nbformat": 4,
        "nbformat_minor": 5,
        "metadata": {
        ...
        "cells": [
            {
                ...
                "metadata": {},
                "source": [
                    "# S25 r3d_18 + r2plus1d_18 rank-mean\n",
                    "\n",
                    "Own PIXEL_CACHE_V1 decoder once, then two 5-fold 3D bags. No A0/Raptor mix.\n",
                ],
            },
            {
                "cell_type": "code",
